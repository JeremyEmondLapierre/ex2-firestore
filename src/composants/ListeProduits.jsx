...
export default function ListeProduits(props) {
  ...
  useEffect(
      ...
      () => dbFirestore.collection('ex2-produits').get().then(
        reponse => {
    ...
    <div className="ListeProduits">
      ...
      <ul>        
        ...
        */}
          ...
          {
                produits.map(unProd => <Produit etatPanier={props.etatPanier} key={unProd.id} nom={unProd.nom} prix={unProd.prix} image ={unProd.image} />)
          } 
